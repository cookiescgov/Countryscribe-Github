...
function App() {
  ...
  const copyToClipboard = () => {
    ...
    if (!showTimestamps) {
        ...
        text = transcription.map(segment => `[${segment.start} - ${segment.end}] ${segment.text}`).join('\n');
    }
                ...
                <div className="modal-content shadow-lg border-0">
                    ...
                    <div className="modal-body p-4" style={{ maxHeight: '70vh', overflowY: 'auto' }}>
                        ...
                        <section className="mb-4">
                            ...
                            <p className="small text-muted">
                                Use the <strong>"Show Details (Timestamps)"</strong> toggle at the top if you need to see exactly when something occurred. By default, it shows a clean, readable draft.
                            </p>
                        </section>
